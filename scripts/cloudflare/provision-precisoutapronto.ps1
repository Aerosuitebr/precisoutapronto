...
#
# Uso:
#   .\scripts\cloudflare\provision-precisoutapronto.ps1 -ApiToken "seu-token"
# ou:
#   $env:CLOUDFLARE_API_TOKEN = "seu-token"
#   .\scripts\cloudflare\provision-precisoutapronto.ps1
...
3. Rode de novo:
   .\scripts\cloudflare\provision-precisoutapronto.ps1 -ApiToken "COLE_O_TOKEN"
...
node "$PSScriptRoot\provision-precisoutapronto-zone.mjs"
...
$result = Get-Content "$PSScriptRoot\provision-precisoutapronto-result.json" -Raw | ConvertFrom-Json
