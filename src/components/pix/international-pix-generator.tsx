...
const copy = {
  en: {
    ...
    privacy: 'Your Pix key and payment details stay in this browser and are not saved by Resolva Jato.',
  ...
  es: {
    ...
    privacy: 'Tu clave Pix y los datos del cobro permanecen en este navegador y Resolva Jato no los guarda.',
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-950">
      ...
      <main className="mx-auto max-w-6xl px-4 py-8 sm:px-6">
        ...
        <div className="mt-6 flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between"><div><h1 className="rj-display text-3xl font-extrabold sm:text-4xl">{t.title}</h1><p className="mt-2 text-slate-600">{t.subtitle}</p></div><Button variant="outline" icon={Sparkles} onClick={loadExample}>{t.example}</Button></div>
