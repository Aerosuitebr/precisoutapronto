  ...
  return (
    <div className="mx-auto max-w-6xl px-4 py-12 sm:px-6 sm:py-16">
      ...
      <header className="rounded-[32px] border border-slate-800 bg-slate-950 p-7 text-white shadow-xl sm:p-10">
        ...
        <h1 className="rj-display mt-4 max-w-4xl text-4xl font-black leading-tight sm:text-5xl">{title}</h1>
      ...
      <article className="mt-10 grid gap-8 lg:grid-cols-2">
        <section className="rounded-3xl border border-slate-200 bg-white p-6 sm:p-8">
          <h2 className="rj-display text-2xl font-extrabold text-slate-950">Como usar</h2>
        ...
        <section className="rounded-3xl border border-slate-200 bg-white p-6 sm:p-8">
          <h2 className="rj-display text-2xl font-extrabold text-slate-950">Perguntas frequentes</h2>
      ...
      <aside className="mt-10 rounded-3xl border border-teal-200 bg-teal-50 p-6 text-center">
        <h2 className="rj-display text-xl font-extrabold text-slate-950">Mais decisões gamer em um só lugar</h2>
