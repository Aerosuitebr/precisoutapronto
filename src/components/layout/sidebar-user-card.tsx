  ...
  if (!isAuthenticated) {
    ...
    return (
      <section className="border-b border-white/10 bg-black/10 px-4 py-4">
        <p className="text-sm font-bold text-white">Ferramentas abertas</p>
        <p className="mt-1 text-xs leading-5 text-slate-400">
          Duas gerações grátis sem conta. Depois, entre para continuar.
        </p>
        <div className="mt-3 flex gap-2">
          <Button size="sm" className="flex-1" onClick={() => router.push('/ferramentas')}>
            Continuar
          </Button>
