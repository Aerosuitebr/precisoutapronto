...
const copy = {
  en: {
    ...
    back: 'Back to tools',
    privacy: 'Appointments are saved to your account in the Precisou, Tá Pronto database and stay synchronized across languages.',
  ...
  es: {
    ...
    privacy: 'Los compromisos se guardan en tu cuenta en la base de datos de Precisou, Tá Pronto y se sincronizan entre idiomas.',
