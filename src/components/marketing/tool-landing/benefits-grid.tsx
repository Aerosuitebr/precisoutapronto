...
export function ToolLandingBenefits({
  ...
  return (
    <section className="mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20">
      <p className="precisoutapronto-display text-sm font-bold uppercase tracking-[0.2em] text-sky-800">Por que usar</p>
      <h2 className="precisoutapronto-display mt-3 max-w-2xl text-3xl font-black tracking-tight text-slate-900 sm:text-4xl">
