  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-950">
      ...
      <main className="mx-auto max-w-6xl px-4 py-8 sm:px-6">
        ...
        <div className="mt-6 flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between"><div><h1 className="precisoutapronto-display text-3xl font-extrabold sm:text-4xl">{t.title}</h1><p className="mt-2 max-w-3xl text-slate-600">{t.subtitle}</p></div><Button variant="outline" icon={Sparkles} onClick={sample}>{t.sample}</Button></div>
