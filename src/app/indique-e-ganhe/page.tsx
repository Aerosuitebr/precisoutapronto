    ...
    <main className="bg-slate-50">
      <header className="overflow-hidden border-b border-amber-200 bg-[linear-gradient(145deg,#020617,#064e3b_58%,#14532d)] text-white">
        <div className="mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20">
          ...
          <h1 className="precisoutapronto-display mt-4 max-w-4xl text-4xl font-extrabold tracking-tight sm:text-6xl">Indique para quem precisa resolver. Ganhe quando a pessoa realmente usar.</h1>
      ...
      <section className="mx-auto max-w-6xl px-4 py-14 sm:px-6">
        ...
        <h2 className="precisoutapronto-display mt-2 text-3xl font-extrabold text-slate-950">Um ciclo simples e verificável</h2>
