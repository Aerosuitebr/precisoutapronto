        ...
        <main className="bg-slate-50">
          ...
          {page.example ? <section className="bg-white"><div className="mx-auto max-w-5xl px-4 py-14 sm:px-6">
            ...
            <div className="mt-6 rounded-2xl border border-emerald-200 bg-emerald-50 p-5">
              <h3 className="font-bold text-slate-950">Do exemplo ao orçamento do seu cliente</h3>
              <p className="mt-2 leading-7 text-slate-700">No formulário, ajuste os itens de {page.name.toLowerCase()}, informe as quantidades e seus preços e copie as condições que se aplicam ao atendimento. Confira a prévia antes de gerar o link para o WhatsApp.</p>
              <LandingConversionLink href="#montar" landingPath={path} placement="inline_primary" className="mt-4 inline-flex font-bold text-emerald-800 underline">Preencher meu orçamento de {page.name.toLowerCase()}</LandingConversionLink>
              <p className="mt-3 text-sm leading-6 text-slate-700">Após confirmar o pagamento no banco, emita o <Link href="/recibos/recibo-pagamento-pix" className="font-semibold text-emerald-800 underline">recibo do Pix recebido</Link>. Se houve entrada e saldo, use o <Link href="/guias/como-registrar-sinal-e-saldo-pix" className="font-semibold text-emerald-800 underline">exemplo de dois recibos para o mesmo orçamento</Link>.</p>
            </div>
          </div></section> : null}
