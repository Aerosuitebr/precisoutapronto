  ...
  return (
    ...
    >
      <div className="space-y-5">
              ...
              <div className="flex flex-wrap gap-2">
                {POPULAR_SEARCHES.map((term) => (
                  <button
                    ...
                    className="precisoutapronto-press rounded-full border border-slate-200 bg-slate-50 px-3 py-1.5 text-sm font-semibold text-slate-700 transition hover:border-sky-300 hover:bg-sky-50 hover:text-sky-700"
                  >
                    {term}
                  </button>
                ))}
        ...
        <nav
          className="sticky top-[var(--precisoutapronto-chrome-top)] z-30 -mx-1 rounded-2xl border border-slate-200/90 bg-white/95 px-2 py-2 shadow-sm backdrop-blur-xl sm:mx-0 sm:px-3"
          ...
          {sections.map(({ category, tools }) => {
            ...
            return (
              <section
                ...
                className="scroll-mt-[var(--precisoutapronto-section-scroll-mt)] rounded-2xl border border-slate-200 bg-white p-4 shadow-sm sm:p-5"
                ...
                <div className="mb-4 flex flex-wrap items-center justify-between gap-2">
                  <div className="flex min-w-0 items-center gap-3">
                    ...
                    <div className="min-w-0">
                      <h2
                        ...
                        className="precisoutapronto-display text-lg font-bold text-slate-900 sm:text-xl"
                      >
                        {category.label}
                      </h2>
                  ...
                  <div className="flex items-center gap-1">
                    <button
                      ...
                      className={cn(
                        'precisoutapronto-press inline-flex h-11 items-center gap-1.5 rounded-xl px-3 text-xs font-semibold transition',
                        isPinned
                    ...
                    <button
                      ...
                      className="precisoutapronto-press inline-flex h-11 w-11 items-center justify-center rounded-xl border border-slate-200 text-slate-600 hover:bg-slate-50"
        ...
        <footer className="rounded-2xl border border-dashed border-slate-300 bg-slate-50/80 px-5 py-6 text-center">
          <p className="precisoutapronto-display text-lg font-bold text-slate-800">Não encontrou o que precisava?</p>
...
function CategoryChip({
  ...
  return (
    <button
      ...
      aria-pressed={active}
      className={cn(
        'precisoutapronto-press h-11 shrink-0 rounded-full px-4 text-sm font-semibold transition',
        active
    ...
    >
      ...
      <div className="pointer-events-none relative z-10 flex flex-1 flex-col">
        <div className="flex items-start gap-3">
          ...
          <div className="min-w-0 flex-1">
            <div className="flex items-start justify-between gap-1">
              <div className="min-w-0">
                <h3 className="precisoutapronto-display text-[0.95rem] font-extrabold leading-snug tracking-tight text-slate-900">
                  {tool.name}
                </h3>
              ...
              <div className="flex shrink-0 items-center">
                ...
                <button
                  ...
                  className={cn(
                    'precisoutapronto-favorite-btn pointer-events-auto inline-flex h-11 w-11 items-center justify-center rounded-xl transition',
        ...
        <div className="mt-auto flex items-center justify-end gap-1.5 pt-3">
          <span className="precisoutapronto-press inline-flex h-11 min-w-[9.5rem] items-center justify-center gap-1.5 rounded-xl bg-sky-600 px-4 text-sm font-bold text-white shadow-sm transition group-hover:bg-sky-500">
            {tool.actionLabel}
