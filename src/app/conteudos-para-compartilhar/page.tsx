...
const videoScripts = [
  ...
  { title: 'PDF privado no navegador', hook: 'Você envia documentos pessoais para qualquer site de PDF?', body: 'Abra um PDF, reorganize e remova uma página. Destaque que o arquivo não sai do dispositivo.', href: '/pdf?utm_source=content_hub&utm_medium=video_script&utm_campaign=pdf_privado', cta: 'Use o Jato PDF sem upload.', campaign: 'pdf_privado' }
] as const;
