  ...
  return new ImageResponse(
    <div style={{ width: '100%', height: '100%', display: 'flex', flexDirection: 'column', justifyContent: 'space-between', padding: 64, color: 'white', background: 'linear-gradient(145deg,#020617 0%,#082f49 58%,#0c4a6e 100%)', fontFamily: 'sans-serif' }}>
      <div style={{ display: 'flex', alignItems: 'center', gap: 18 }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column' }}><span style={{ fontSize: 30, fontWeight: 800 }}>Resolva Jato</span><span style={{ marginTop: 4, color: '#7dd3fc', fontSize: 18, fontWeight: 700, letterSpacing: 2 }}>RESULTADO JATO</span></div>
      </div>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', color: '#bae6fd', fontSize: 21, fontWeight: 700 }}><span>Crie o seu grátis</span><span>resolvajato.com.br</span></div>
    </div>,
