...
export default function OfficialBrandPage() {
  ...
  return <>
    ...
    <LegalPage title={`${BRAND_DISPLAY_NAME} Site oficial`} subtitle={BRAND_TAGLINE}>
      <p><strong>{BRAND_DISPLAY_NAME}</strong> é uma plataforma brasileira de ferramentas online operada pela Aerosuite. Nosso único domínio oficial é <strong>precisoutapronto.com.br</strong>. Qualquer outro endereço antigo da plataforma redireciona para este site, no mesmo caminho.</p>
