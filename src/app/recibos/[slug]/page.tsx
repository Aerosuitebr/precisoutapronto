    ...
    <main>
      <article>
        <header className="border-b border-slate-200 bg-slate-50"><div className="mx-auto max-w-4xl px-4 py-12 sm:px-6 sm:py-16">
          ...
          <Link href="/gerador-de-recibo#ferramenta" className="mt-7 inline-flex items-center gap-2 rounded-xl bg-slate-950 px-6 py-3 font-bold text-white">{page.slug === 'recibo-pagamento-pix' ? 'Gerar recibo de Pix grátis' : 'Gerar este recibo grátis'} <ArrowRight className="h-4 w-4" /></Link>
        </div></header>
        <div className="mx-auto max-w-4xl px-4 py-12 sm:px-6">
          ...
          {page.slug === 'recibo-pagamento-pix' ? (
            <section className="mt-12 rounded-3xl border border-emerald-200 bg-emerald-50 p-6 sm:p-8">
              ...
              <Link href="/gerador-de-recibo#ferramenta" className="mt-6 inline-flex items-center gap-2 rounded-xl bg-slate-950 px-6 py-3 font-bold text-white">Gerar recibo de Pix grátis <ArrowRight className="h-4 w-4" /></Link>
            </section>
          ) : null}
