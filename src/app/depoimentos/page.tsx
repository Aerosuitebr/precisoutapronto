...
export default function TestimonialsIntakePage() {
  return <><SiteHeader /><main className="bg-slate-50"><header className="border-b border-sky-200 bg-white"><div className="mx-auto max-w-4xl px-4 py-16 sm:px-6"><Quote className="h-8 w-8 text-sky-600" /><p className="mt-4 text-xs font-bold uppercase tracking-[0.18em] text-sky-700">Histórias reais do Brasil</p><h1 className="rj-display mt-3 text-4xl font-extrabold text-slate-950 sm:text-5xl">O que você resolveu na prática?</h1><p className="mt-5 max-w-2xl text-lg leading-8 text-slate-600">Queremos mostrar pessoas reais, profissão real e contexto real — nunca avaliações compradas ou inventadas.</p></div></header>
