...
export const metadata: Metadata = {
  title: 'Qualidade Jato: testes, privacidade e segurança',
  description: 'Conheça os critérios usados pelo Resolva Jato para testar ferramentas, proteger arquivos, documentar limites e publicar resultados confiáveis.',
  alternates: { canonical: '/qualidade-e-seguranca' },
  openGraph: { title: 'Qualidade e segurança | Resolva Jato', description: 'Como testamos ferramentas e protegemos seus arquivos.', url: '/qualidade-e-seguranca' }
};

export default function QualidadeESegurancaPage() {
  return <LegalPage title="Qualidade Jato" subtitle="Testes reais, limites claros e privacidade por projeto">
    <p><strong>Qualidade Jato</strong> é o compromisso público usado antes de uma ferramenta ser liberada. Ela precisa cumprir sua finalidade, informar limites e produzir resultados verificáveis.</p>
    ...
    <h2>Privacidade Jato</h2>
    <p>Quando indicamos “processamento local”, o arquivo é manipulado no próprio navegador e não é enviado ao servidor do Resolva Jato. Essa característica aparece explicitamente na interface da ferramenta.</p>
