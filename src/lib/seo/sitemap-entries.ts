...
const VERIFIED_LASTMOD_BY_PATH = new Map<string, Date>([
  ...
  ['/orcamento-com-pix', new Date('2026-09-19T12:00:00.000Z')],
  ...
  ['/recibos/recibo-pagamento-pix', new Date('2026-09-19T12:00:00.000Z')],
  ...
  ['/gerador-de-recibo', new Date('2026-09-19T12:00:00.000Z')],
