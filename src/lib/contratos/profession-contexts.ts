...
export const CONTRACT_PROFESSION_CONTEXTS: ContractProfessionContext[] = [
  ...
  { slug: 'desenvolvimento-de-software', name: 'Desenvolvimento de software', title: 'Contrato de desenvolvimento de software com escopo e aceite', description: 'Defina entregas, marcos, homologação, propriedade intelectual, manutenção e pagamento em um contrato editável.', objectDescription: 'Desenvolvimento e entrega do software descrito no escopo aprovado, incluindo funcionalidades, integrações, marcos, critérios de aceite e itens expressamente excluídos.', paymentTerms: 'Pagamento por marcos de entrega, com entrada na contratação e saldo conforme etapas homologadas pelo contratante.', checklist: ['Funcionalidades e fora de escopo', 'Homologação e correções', 'Código-fonte, licenças e manutenção'], faqs: [{ q: 'Como tratar mudanças de escopo?', a: 'Exija registro e orçamento complementar para funcionalidades que não constem no escopo aprovado.' }, { q: 'Quem fica com o código-fonte?', a: 'Defina cessão ou licença, momento da transferência e tratamento de bibliotecas de terceiros.' }] },
