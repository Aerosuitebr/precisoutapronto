...
## Links canônicos com UTM

### Calculadoras (prioridade máxima)
...
- `utm_source=contador_joao&utm_medium=partner&utm_campaign=rescisao`
- `utm_source=canal_mei&utm_medium=partner&utm_campaign=mei_clt`

---

## Copies prontas (colar e publicar)

### 1) WhatsApp Status · Rescisão

```text
Demissão ou pedido de conta?
...
### 2) Instagram / Stories · MEI ou CLT

```text
CLT ou MEI: qual sobra mais no bolso?
Simule os dois cenários em 1 minuto.
Sem cadastro.
...
```text
Muitos freelancers cobram “de feeling” e descobrem depois que o preço não cobre custo fixo, imposto e tempo de revisão.
...
```text
Ferramenta útil pra quem está em dúvida entre MEI e CLT:
...
• Geradores de currículo, contrato, recibo e proposta
• Calculadoras de rescisão, preço freelancer e MEI vs CLT

Feedback sincero é bem-vindo, sobretudo de MEIs e freelancers.
```
...
## Diretórios e listagens (checklist)
...
| Dia | Ação |
|-----|------|
| 1 | Stories + Status com card da rescisão |
| 2 | Post LinkedIn de precificação |
| 3 | Post comunidade MEI (MEI vs CLT) |
| 4 | Product Hunt: preparar assets e tagline |
| 5 | Publicar 1 guia novo no Stories (aviso-prévio) |
| 6 | Contatar 3 contadores / creators para parceria |
| 7 | Revisar GA4: sessões por UTM `share` e `organic_social` |
| 8 | Thread X sobre preço por hora |
| 9 | AlternativeTo + 1 diretório BR |
| 10 | Status com card MEI vs CLT |
| 11 | Guest post / comentário útil em blog de MEI (com link editorial) |
| 12 | Pedir indexação GSC/Bing das URLs novas |
| 13 | Repost do melhor card (melhor CTR no Clarity) |
| 14 | Revisar: top landings, `begin_checkout`, `share_result` |
...
- Comprar reviews ou backlinks disfarçados.
- Spam em grupos com o mesmo texto repetido.
- Prometer “homologação oficial”, “cálculo jurídico garantido” ou “substitui contador”.
- Postar print com dados pessoais de clientes.

## Medição (GA4)

Acompanhar:

- Sessões por `utm_campaign` (`rescisao_*`, `preco_*`, `mei_clt_*`, `guia_*`)
- Evento `share_result` (WhatsApp, copy, imagem)
- `begin_checkout` e `purchase`
- Landings: `/calculadora-de-rescisao`, `/calculadora-de-preco-freelancer`, `/mei-ou-clt`
