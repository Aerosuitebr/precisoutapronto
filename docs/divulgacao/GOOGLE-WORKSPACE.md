# Google Workspace · Resolva Jato

Caixa oficial: `contato@resolvajato.com.br`  
...
| TXT | `_dmarc` | `v=DMARC1; p=none; rua=mailto:contato@resolvajato.com.br` (suba para `quarantine` depois de validar) |
...
1. Conta `contato@resolvajato.com.br` com 2FA.
2. Conta Google > Segurança > Senhas de app > gerar para “Resolva Jato SMTP”.
3. Em produção (`/opt/resolva-jato/.env`):

```env
SMTP_HOST=smtp.gmail.com
SMTP_PORT=587
SMTP_USER=contato@resolvajato.com.br
SMTP_PASS=<senha-de-app>
SMTP_FROM=Resolva Jato <contato@resolvajato.com.br>
SMTP_SSL=false
...
Staging (`/opt/resolva-jato-staging`): mesma caixa, com `SMTP_FROM=Resolva Jato Staging <contato@resolvajato.com.br>`.
...
2. Confirme que a mensagem de verificação chega de `contato@resolvajato.com.br`.
...
1. Propriedade de **domínio** `resolvajato.com.br` (já verificada).
...
- Site: `https://resolvajato.com.br`
- E-mail: `contato@resolvajato.com.br`
...
https://resolvajato.com.br/?utm_source=email&utm_medium=signature&utm_campaign=workspace
