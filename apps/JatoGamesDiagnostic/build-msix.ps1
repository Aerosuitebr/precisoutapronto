param(
  [string]$IdentityName = 'Aerosuite.JatoGamesDiagnostic',
...
$outputRoot = Join-Path $repositoryRoot 'dist\JatoGamesDiagnostic'
$publishRoot = Join-Path $outputRoot 'msix-content'
$msixPath = Join-Path $outputRoot "JatoGamesDiagnostic-$Version-x64.msix"
